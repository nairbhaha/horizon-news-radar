...
def main():
    ...
    parser.add_argument("--topics", type=str, help="Comma-separated topics of interest (e.g. 'AI, Python, Rust')")
    ...
    try:
        ...
        asyncio.run(orchestrator.run(force_hours=args.hours, focus_topics=args.topics))
